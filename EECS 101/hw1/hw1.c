...
{
	int				i;
	float			t, x, y, z, xprime, yprime, x1, y1, z1, xprime1, yprime1;
	FILE			*fp;
	char			 *ofile;
	...
	for (t = 0.01; t < 10000.01; t += .01)  //change the t range
	{
		...
		//Number 1 line parameters:
		x = 0.5 + t * 0.0;
		y = -1.0 + t;
		z = -t;

		//Number 2 line 1 parameters with z = -1
		/*x = 0.5 + t;
		y = -1.0 + t;
		z = -1.0;*/
		//Number 2 line 1 parameters with z = -2
		/*x = 0.5 + t;
		y = -1.0 + t;
		z = -2.0;*/
		//Number 2 line 1 parameters with z = -3
		/*x = 0.5 + t;
		y = -1.0 + t;
		z = -3.0;*/

		//Number 2 line 2 parameters with z = -1
		/*x1 = -0.5 + t;
		y1 = -1.0 + t;
		z1 = -1.0;*/
		//Number 2 line 2 parameters with z = -2
		/*x1 = -0.5 + t;
		y1 = -1.0 + t;
		z1 = -2.0;*/
		//Number 2 line 2 parameters with z = -3
		/*x1 = -0.5 + t;
		y1 = -1.0 + t;
		z1 = -3.0;*/

		//Number 3 line 1 parameters with b = 0, c = 1
		/*x = -1.0;
		y = -1.0;
		z = t;*/
		//Number 3 line 1 parameters with b = 0, c = -1
		...
		//Number 3 line 1 parameters with b = 1, c = 1
		/*x = -1.0;
		y = -1.0 + t;
		z = t;*/
		//Number 3 line 1 parameters with b = 1, c = -1
		...
		//Number 3 line 2 parameters with b = 0, c = 1
		/*x1 = 1.0;
		y1 = -1.0;
		z1 = t;*/
		//Number 3 line 2 parameters with b = 0, c = -1
		...
		//Number 3 line 2 parameters with b = 1, c = 1
		/*x1 = 1.0;
		y1 = -1.0 + t;
		z1 = t;*/
		//Number 3 line 2 parameters with b = 1, c = -1
		...
		//x1, y1, z1, xprime1, yprime1 all for line 2's
		//orthographic:
		xprime = x;			
		yprime = y;
		/*xprime1 = x1;
